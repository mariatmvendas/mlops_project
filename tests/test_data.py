...
#     """
#     # Explicitly referencing the fixture to satisfy Pylance
#     _ = create_mock_data
...
def test_organize_and_rename_images():#(create_mock_data):
    ...
    assert len(os.listdir(train_folder)) == 16  # 80% of 5 images
    assert len(os.listdir(test_folder)) == 4   # 20% of 5 images
